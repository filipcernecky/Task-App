...
public class TaskDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(
                "CREATE TABLE "+CONTACTS_TABLE_NAME +
                        "(id INTEGER PRIMARY KEY, task TEXT, 'desc' TEXT, dateStr INTEGER)"
        );
    }
    ...
    public boolean insertContact  (String task, String desc, String dateStr)
    {
        Date date;
    ...
    public boolean updateContact (String id, String task, String desc, String dateStr)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
